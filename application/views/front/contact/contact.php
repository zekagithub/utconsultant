...
<div class="boxed_wrapper">
    ...
    <section class="contact-info-area">
        <div class="container">
            <div class="sec-title text-center">
                <div class="title"><?php  echo $this->lang->line('ulas'); ?></div>
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
                    <div class="contact-form">
                        ...
                        <form  class="default-form" action="<?php echo base_url('front/message');  ?>" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button class="btn-one thm-bg-clr" type="submit" >Şimdi gönder</button>
                                    <div class="button-text">
                                        <p>Senin soruların var? Bugün bize ulaşın, destek ekibimiz size <br> 24 * 7 ile yardımcı olmak için.</p>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="contact-info-box-one">
                            <div class="contact-box1-carousel owl-carousel owl-theme">
                                ...
                                <div class="single-item">
                                    <div class="title"><h3>Ut danişmanlik merkez ofisi</h3></div>
                                    <ul>
                                        <li>
                                            <div class="icon-box">
                                            ...
                                            <div class="text-box">
                                                <p><span>Address:</span><?php echo $melumat->adress;  ?></p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon-box">
                                            ...
                                            <div class="text-box">
                                                <p><span>Call Us:</span><br> <?php echo $melumat->phone  ?></p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon-box">
                                            ...
                                            <div class="text-box">
                                                <p><span>Mail Us:</span> <?php echo $melumat->mail  ?></p>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <!--Start single item-->
                                <div class="single-item">
                                    <div class="title"><h3>Baku Office</h3></div>
                                    <ul>
                                        <li>
                                            <div class="icon-box">
                                                <span class="icon-signs thm-clr"></span>
                                            ...
                                            <div class="text-box">
                                                <p><span>Address:</span> <?php echo $melumat->adress2   ?></p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon-box">
    ...
    <section class="google-map-area">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="google-map-box"  id="contact-google-map" >
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24494.356222705872!2d32.64387616799197!3d39.878840183570865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14d33931c49a544f%3A0x5c9cb05083585432!2zS29udXRrZW50LCAwNjgxMCDDh2Fua2F5YS9BbmthcmEgaWxpLCBUw7xya2l5yZk!5e0!3m2!1saz!2s!4v1567323162085!5m2!1saz!2s"  width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen=""></iframe>
...
<!-- Mirrored from steelthemes.com/demo/html/Brighton/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Aug 2018 21:17:24 GMT -->
</html>